...
flags.DEFINE_string(
    "bert_config_file", 'uncased_base/bert_config.json',
    "The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string("task_name", 'mytask', "The name of the task to train.")

flags.DEFINE_string("vocab_file", 'uncased_base/vocab.txt',
                    "The vocabulary file that the BERT model was trained on.")

flags.DEFINE_string(
    "output_dir", 'batchnormal_output',
    "The output directory where the model checkpoints will be written.")

## Other parameters

flags.DEFINE_string(
    "init_checkpoint", 'batchnormal_output/model.ckpt-10725',
    # "init_checkpoint", 'uncased_base/bert_model.ckpt',a
    "Initial checkpoint (usually from a pre-trained BEfRT model).")
...
class MyTaskProcessor(DataProcessor):
    ...
    def __init__(self):
        self.labels = [str(i) for i in range(14)]
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    with tf.variable_scope("loss"):
        ...
        # counts = {8: 2123, 9: 1058, 10: 621, 5: 493, 6: 466, 1: 294, 7: 229, 4: 209, 0: 144, 11: 129, 13: 108, 3: 107,
        # 		  12: 76, 2: 72}
        # weightsArray = []
        # for i in range(14):
        # 	weightsArray.append(math.log(counts[i] / 6129))
        #
...
def model_fn_builder(bert_config, num_labels, init_checkpoint, learning_rate,
    ...
    def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
        ...
        (total_loss, per_example_loss, logits, probabilities, output) = create_model(
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            output_spec = tf.contrib.tpu.TPUEstimatorSpec(
                ...
                scaffold_fn=scaffold_fn)
        # o = tf.get_default_graph().get_tensor_by_name("bert/pooler/dense/Tanh:0")
...
def main(_):
    ...
    if FLAGS.do_predict:
        ...
        output_predict_file = os.path.join(FLAGS.output_dir, "unbalanced_test_results.tsv")
